...
function ProposalDocument({ deal, pricing }: ProposalDocProps) {
  ...
  return createElement(Document, {},
    ...
    createElement(Page, { size: 'A4', style: styles.coverPage },
      createElement(Text, { style: styles.coverLogo }, 'SHIFT4'),
      createElement(Text, { style: styles.coverTagline }, 'Payment Technology Solutions'),
      ...
      createElement(View, { style: styles.footer },
        createElement(Text, {}, 'Shift4 — Confidential'),
    ...
    createElement(Page, { size: 'A4', style: styles.page },
      ...
      createElement(View, { style: styles.table },
        ...
        createElement(View, { style: styles.tableRow },
          createElement(Text, { style: styles.tableCellBold }, 'Shift4 Margin'),
      ...
      createElement(Text, { style: styles.termsText }, '6. Shift4 reserves the right to adjust pricing based on risk assessment and compliance review.'),
