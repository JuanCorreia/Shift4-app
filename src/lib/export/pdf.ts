    ...
    createElement(Page, { size: 'A4', style: styles.page },
      ...
      ...(pricing.dccRevenue ? [
        ...
        createElement(View, { key: 'dcc-box', style: styles.dccBox },
          ...
          createElement(View, { style: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 } },
            createElement(Text, { style: { fontSize: 9, color: TEXT_MUTED } }, 'Projected Uptake Volume:'),
            createElement(Text, { style: { fontSize: 9, fontFamily: 'Helvetica-Bold' } }, formatEur(pricing.dccRevenue.projectedUptake)),
          ),
          createElement(View, { style: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 } },
